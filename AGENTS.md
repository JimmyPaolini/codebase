...
- **[callidescope-nx](packages/callidescope-nx)**: Nx plugin inferring a per-project trace target, scoped through the Nx dependency graph — the only callidescope package that knows Nx exists
