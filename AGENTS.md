...
- **[synchronization](tools/synchronization)**: NestJS CLI for synchronizing monorepo configuration and documentation artifacts
...
- **[nx-import](.agents/skills/nx-import/SKILL.md)**: Import, merge, or combine repositories into an Nx workspace using nx import. USE WHEN the user asks to adopt Nx across repos, move projects into a monorepo, or bring code/history from another repository.
