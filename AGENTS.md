...
- **[callidescope-nx](packages/callidescope-nx)**: Resolves Nx project names and tags to the workspace-relative directories `callidescope --directories` takes — the only callidescope package that knows Nx exists
