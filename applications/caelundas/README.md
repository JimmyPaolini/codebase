...
<details>
<summary>508 more callables</summary>
...
| `PhasesService.detectProgressive` | 8 | `PhasesService.filter(…)`, `PhasesService.filter(…)`, `VenusianPhaseService.getVenusianPhaseProgressiveEvents`, `PhasesService.filter(…)`, `MercurianPhaseService.getMercurianPhaseProgressiveEvents`, `PhasesService.filter(…)`, `MartianPhaseService.getMartianPhaseProgressiveEvents`, `LoggerService.debug` | `applications/caelundas/src/modules/phases/phases.service.ts:104` |
...
| `CaelundasCommand.run` | 7 | `LoggerService.debug`, `InputService.parse`, `PerfectiveService.detect`, `LoggerService.info`, `ProgressiveService.detect`, `CaelundasCommand.toSorted(…)`, `CalendarService.write` | `applications/caelundas/src/modules/caelundas/caelundas.command.ts:59` |
...
| `TwilightsService.detectProgressive` | 6 | `TwilightsService.filter(…)`, `TwilightsService.getEventsByCategory`, `TwilightsComposerService.buildDawnProgressiveEvents`, `TwilightsComposerService.buildDuskProgressiveEvents`, `TwilightsComposerService.pairAndBuild`, `LoggerService.debug` | `applications/caelundas/src/modules/twilights/twilights.service.ts:163` |
...
| `TripleAspectsComposerService.buildProgressiveBodiesMeta` | 5 | `TripleAspectsComposerService.map(…)`, `TripleAspectsComposerService.filter(…)`, `TripleAspectsComposerService.resolveAspectType`, `LoggerService.warn`, `TripleAspectsComposerService.resolveProgressiveMeta` | `applications/caelundas/src/modules/triple-aspects/triple-aspects-composer.service.ts:49` |
...
| `IngressesService.detect` | 4 | `IngressesService.getSignIngressEvents`, `IngressesService.getDecanIngressEvents`, `IngressesService.getPeakIngressEvents`, `LoggerService.debug` | `applications/caelundas/src/modules/ingresses/ingresses.service.ts:131` |
| `IngressesService.detectProgressive` | 4 | `IngressesComposerService.filterSignIngressEvents`, `IngressesComposerService.groupSignIngressEventsByBody`, `IngressesComposerService.buildProgressiveSpansForBody`, `LoggerService.debug` | `applications/caelundas/src/modules/ingresses/ingresses.service.ts:153` |
...
| `TripleAspectsComposerService.buildTripleAspectEvent` | 4 | `TripleAspectsComposerService.buildTripleAspectDescription`, `TripleAspectsComposerService.getPhaseEmoji`, `LoggerService.info`, `TripleAspectsComposerService.buildTripleAspectCategories` | `applications/caelundas/src/modules/triple-aspects/triple-aspects-composer.service.ts:327` |
| `AspectsService.detect` | 4 | `AspectsService.detectSimpleAspects`, `AspectsService.computeAspectBodies`, `AspectsService.detectCompositeAspects`, `LoggerService.debug` | `applications/caelundas/src/modules/aspects/aspects.service.ts:185` |
| `EclipsesService.detect` | 4 | `EclipseCalculationService.getAllEclipseCoordinates`, `EclipseCalculationService.getGeocentricEvents`, `EclipseCalculationService.getTopocentricEventsForDetect`, `LoggerService.debug` | `applications/caelundas/src/modules/eclipses/eclipses.service.ts:66` |
| `MonthlyLunarCycleService.extractLunarPhaseFromCategories` | 4 | `MonthlyLunarCycleService.map(…)`, `MonthlyLunarCycleService.find(…)`, `LoggerService.warn`, `isLunarPhase` | `applications/caelundas/src/modules/monthly-lunar-cycle/monthly-lunar-cycle.service.ts:99` |
| `PhasesService.detect` | 4 | `PhasesService.getMartianPhaseEvents`, `PhasesService.getMercurianPhaseEvents`, `PhasesService.getVenusianPhaseEvents`, `LoggerService.debug` | `applications/caelundas/src/modules/phases/phases.service.ts:52` |
...
| `CalendarService.write` | 3 | `CalendarService.buildFileContent`, `LoggerService.error`, `LoggerService.info` | `applications/caelundas/src/modules/calendar/calendar.service.ts:208` |
...
| `IngressesComposerService.buildPeakIngressEvent` | 3 | `IngressesComposerService.getSign`, `capitalize`, `LoggerService.info` | `applications/caelundas/src/modules/ingresses/ingresses-composer.service.ts:143` |
...
| `MajorAspectEventService.buildMajorAspectEvent` | 3 | `MajorAspectEventService.getMajorAspect`, `LoggerService.error`, `MajorAspectEventService.assembleMajorAspectEvent` | `applications/caelundas/src/modules/major-aspects/major-aspect-event.service.ts:121` |
...
| `MinorAspectsService.buildMinorAspectEvent` | 3 | `MinorAspectsService.getMinorAspect`, `LoggerService.error`, `MinorAspectsEventService.assembleMinorAspectEvent` | `applications/caelundas/src/modules/minor-aspects/minor-aspects.service.ts:126` |
...
| `SpecialtyAspectsService.buildSpecialtyAspectEvent` | 3 | `SpecialtyAspectsService.getSpecialtyAspect`, `LoggerService.error`, `SpecialtyAspectsEventService.assembleSpecialtyAspectEvent` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects.service.ts:148` |
...
| `DailyCyclesService.detect` | 3 | `DailyCyclesService.getDailySolarCycleEvents`, `DailyCyclesService.getDailyLunarCycleEvents`, `LoggerService.debug` | `applications/caelundas/src/modules/daily-cycles/daily-cycles.service.ts:138` |
...
| `TwilightsService.detect` | 3 | `TwilightsDetectorService.getSunElevations`, `TwilightsDetectorService.buildTwilightTransitionEvents`, `LoggerService.debug` | `applications/caelundas/src/modules/twilights/twilights.service.ts:133` |
...
| `PerfectiveService.detect` | 3 | `DatetimeService.generateDates`, `PerfectiveService.detectDayEvents`, `LoggerService.info` | `applications/caelundas/src/modules/perfective/perfective.service.ts:203` |
| `MinorAspectsComposerService.assembleMinorAspectEvent` | 3 | `capitalize`, `MinorAspectsComposerService.resolvePhaseDetails`, `LoggerService.info` | `applications/caelundas/src/modules/minor-aspects/minor-aspects-composer.service.ts:59` |
...
| `IngressesComposerService.buildDecanIngressEvent` | 2 | `IngressesComposerService.buildDecanIngressEventObject`, `LoggerService.info` | `applications/caelundas/src/modules/ingresses/ingresses-composer.service.ts:94` |
...
| `IngressesComposerService.buildSignIngressEvent` | 2 | `IngressesComposerService.getSign`, `LoggerService.info` | `applications/caelundas/src/modules/ingresses/ingresses-composer.service.ts:206` |
...
| `MajorAspectEventService.assembleMajorAspectEvent` | 2 | `MajorAspectEventService.buildAspectEventParts`, `LoggerService.info` | `applications/caelundas/src/modules/major-aspects/major-aspect-event.service.ts:54` |
| `ProgressiveAspectService.extractTypedAspectPartsOrThrow` | 2 | `ProgressiveAspectService.extractTypedAspectParts`, `LoggerService.error` | `applications/caelundas/src/modules/progressive/progressive-aspect.service.ts:275` |
| `MajorAspectsService.constructor` | 2 | `LoggerService.setContext`, `AspectsUtilitiesService.getIsAspect` | `applications/caelundas/src/modules/major-aspects/major-aspects.service.ts:33` |
...
| `MinorAspectsService.constructor` | 2 | `LoggerService.setContext`, `AspectsUtilitiesService.getIsAspect` | `applications/caelundas/src/modules/minor-aspects/minor-aspects.service.ts:37` |
...
| `SpecialtyAspectsService.constructor` | 2 | `LoggerService.setContext`, `AspectsUtilitiesService.getIsAspect` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects.service.ts:37` |
...
| `EclipsesService.detectProgressive` | 2 | `EclipseEventService.detectProgressive`, `LoggerService.debug` | `applications/caelundas/src/modules/eclipses/eclipses.service.ts:122` |
...
| `MartianPhaseService.buildMartianPhaseEvent` | 2 | `PhaseCalculationService.formatTimeZoneIso`, `LoggerService.info` | `applications/caelundas/src/modules/phases/martian-phase.service.ts:97` |
...
| `MercurianPhaseService.buildMercurianPhaseEvent` | 2 | `PhaseCalculationService.formatTimeZoneIso`, `LoggerService.info` | `applications/caelundas/src/modules/phases/mercurian-phase.service.ts:136` |
...
| `VenusianPhaseService.buildVenusianPhaseEvent` | 2 | `PhaseCalculationService.formatTimeZoneIso`, `LoggerService.info` | `applications/caelundas/src/modules/phases/venusian-phase.service.ts:131` |
...
| `RetrogradesService.buildRetrogradeEvent` | 2 | `capitalize`, `LoggerService.info` | `applications/caelundas/src/modules/retrogrades/retrogrades.service.ts:243` |
| `main` | 2 | `LoggerService.constructor`, `LoggerService.setContext` | `applications/caelundas/src/main.ts:9` |
...
| `CalendarService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/calendar/calendar.service.ts:27` |
...
| `IngressesComposerService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/ingresses/ingresses-composer.service.ts:34` |
...
| `IngressesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/ingresses/ingresses.service.ts:29` |
...
| `MajorAspectEventService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/major-aspects/major-aspect-event.service.ts:29` |
...
| `ProgressiveAspectService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/progressive/progressive-aspect.service.ts:16` |
...
| `ProgressiveUtilitiesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/progressive/progressive-utilities.service.ts:18` |
| `ProgressiveUtilitiesService.pairProgressiveEvents` | 1 | `LoggerService.warn` | `applications/caelundas/src/modules/progressive/progressive-utilities.service.ts:33` |
...
| `AnnualSolarCycleEventsService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/annual-solar-cycle/annual-solar-cycle-events.service.ts:27` |
| `AnnualSolarCycleEventsService.buildSolarCycleEvent` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/annual-solar-cycle/annual-solar-cycle-events.service.ts:38` |
...
| `AnnualSolarCycleService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/annual-solar-cycle/annual-solar-cycle.service.ts:43` |
...
| `MinorAspectsEventService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/minor-aspects/minor-aspects-event.service.ts:27` |
...
| `MinorAspectsEventService.log` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/minor-aspects/minor-aspects-event.service.ts:61` |
...
| `SpecialtyAspectsEventService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects-event.service.ts:27` |
...
| `SpecialtyAspectsEventService.log` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects-event.service.ts:61` |
...
| `TripleAspectsComposerService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/triple-aspects/triple-aspects-composer.service.ts:32` |
...
| `TripleAspectsComposerService.resolveProgressiveMeta` | 1 | `LoggerService.warn` | `applications/caelundas/src/modules/triple-aspects/triple-aspects-composer.service.ts:227` |
...
| `AspectsService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/aspects/aspects.service.ts:36` |
| `AspectsService.map(…)` | 1 | `AspectsService.makeKey` | `applications/caelundas/src/modules/aspects/aspects.service.ts:165` |
| `AspectsService.detectProgressive` | 1 | `LoggerService.debug` | `applications/caelundas/src/modules/aspects/aspects.service.ts:218` |
| `DailyCyclesBuilderService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/daily-cycles/daily-cycles-builder.service.ts:18` |
...
| `DailyCyclesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/daily-cycles/daily-cycles.service.ts:23` |
...
| `EclipseEventService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/eclipses/eclipse-event.service.ts:19` |
| `EclipseEventService.buildEclipseEvent` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/eclipses/eclipse-event.service.ts:37` |
| `EclipseGeometryService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/eclipses/eclipse-geometry.service.ts:23` |
...
| `EclipseTopocentricService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/eclipses/eclipse-topocentric.service.ts:23` |
...
| `EclipseCalculationService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/eclipses/eclipse-calculation.service.ts:28` |
...
| `EclipsesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/eclipses/eclipses.service.ts:25` |
...
| `InputService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/input/input.service.ts:21` |
| `InputService.parse` | 1 | `LoggerService.debug` | `applications/caelundas/src/modules/input/input.service.ts:45` |
| `MonthlyLunarCycleService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/monthly-lunar-cycle/monthly-lunar-cycle.service.ts:28` |
...
| `TwilightsBuilderService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/twilights/twilights-builder.service.ts:15` |
| `TwilightsBuilderService.buildTransitionEvent` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/twilights/twilights-builder.service.ts:32` |
...
| `TwilightsService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/twilights/twilights.service.ts:27` |
...
| `PhaseCalculationService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/phases/phase-calculation.service.ts:33` |
...
| `MartianPhaseService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/phases/martian-phase.service.ts:42` |
| `MercurianPhaseService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/phases/mercurian-phase.service.ts:42` |
| `VenusianPhaseService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/phases/venusian-phase.service.ts:42` |
| `PhasesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/phases/phases.service.ts:30` |
...
| `RetrogradesService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/retrogrades/retrogrades.service.ts:36` |
...
| `PerfectiveService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/perfective/perfective.service.ts:35` |
| `CaelundasCommand.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/caelundas/caelundas.command.ts:27` |
| `MinorAspectsComposerService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/minor-aspects/minor-aspects-composer.service.ts:40` |
...
| `SpecialtyAspectsComposerService.constructor` | 1 | `LoggerService.setContext` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects-composer.service.ts:34` |
| `SpecialtyAspectsComposerService.buildSpecialtyAspectEventFromParts` | 1 | `LoggerService.info` | `applications/caelundas/src/modules/specialty-aspects/specialty-aspects-composer.service.ts:52` |
