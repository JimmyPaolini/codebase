...
The named counts did not move when the family gained junctions, and that is the rule set
working rather than a coincidence: each rule requires the **absence** of the directions
