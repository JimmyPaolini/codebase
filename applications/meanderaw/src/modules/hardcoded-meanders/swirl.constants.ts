...
/**
 * Part of `swirl`'s committed corpus, extracted once by
 * `scripts/generate-hardcoded-corpus.ts` from `output/swirl/**\/*.svg`
...
/* cspell:disable */
export const SWIRL_HARDCODED_MEANDERS: readonly HardcodedMeanderEntry[] = [
  {
