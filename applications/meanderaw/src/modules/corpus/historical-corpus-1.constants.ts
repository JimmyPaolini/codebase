...
export const HISTORICAL_CORPUS_1: readonly CorpusEntry[] = [
  ...
  { code: "2529", columns: 2, filedUnder: ["boxes", "branch"], rows: 3 },
  { code: "44616525a9a18829", columns: 8, filedUnder: ["boxes"], rows: 3 },
  { code: "6561442588a1a929", columns: 8, filedUnder: ["boxes"], rows: 3 },
  { code: "23561ca39", columns: 3, filedUnder: ["boxes"], rows: 4 },
  {
  ...
  { code: "2335635cc29ca339", columns: 4, filedUnder: ["boxes"], rows: 5 },
  {
  ...
  { code: "61e1e1e1e1e1e1e1a1", columns: 2, filedUnder: ["branch"], rows: 10 },
  { code: "252d2d2d2d2d2d2d29", columns: 2, filedUnder: ["branch"], rows: 10 },
  {
  ...
  { code: "4488", columns: 2, filedUnder: ["branch", "parallel"], rows: 3 },
  { code: "61a1", columns: 2, filedUnder: ["branch"], rows: 3 },
  { code: "544677abb988", columns: 6, filedUnder: ["branch"], rows: 3 },
  { code: "54446777abbb9888", columns: 8, filedUnder: ["branch"], rows: 3 },
  {
  ...
  { code: "44cc88", columns: 2, filedUnder: ["branch", "parallel"], rows: 4 },
  { code: "61e1a1", columns: 2, filedUnder: ["branch"], rows: 4 },
  { code: "252d29", columns: 2, filedUnder: ["branch"], rows: 4 },
  { code: "544677ccccccabb988", columns: 6, filedUnder: ["branch"], rows: 4 },
  {
  ...
  { code: "44cccc88", columns: 2, filedUnder: ["branch", "parallel"], rows: 5 },
  { code: "61e1e1a1", columns: 2, filedUnder: ["branch"], rows: 5 },
  { code: "252d2d29", columns: 2, filedUnder: ["branch"], rows: 5 },
  {
  ...
  { code: "61e1e1e1a1", columns: 2, filedUnder: ["branch"], rows: 6 },
  { code: "252d2d2d29", columns: 2, filedUnder: ["branch"], rows: 6 },
  {
  ...
  { code: "61e1e1e1e1a1", columns: 2, filedUnder: ["branch"], rows: 7 },
  { code: "252d2d2d2d29", columns: 2, filedUnder: ["branch"], rows: 7 },
  {
  ...
  { code: "61e1e1e1e1e1a1", columns: 2, filedUnder: ["branch"], rows: 8 },
  { code: "252d2d2d2d2d29", columns: 2, filedUnder: ["branch"], rows: 8 },
  {
  ...
  { code: "61e1e1e1e1e1e1a1", columns: 2, filedUnder: ["branch"], rows: 9 },
  { code: "252d2d2d2d2d2d29", columns: 2, filedUnder: ["branch"], rows: 9 },
  {
