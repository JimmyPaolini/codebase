...
export const HISTORICAL_CORPUS_10: readonly CorpusEntry[] = [
  ...
  { code: "44cccca956cccc88", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44cccca965cccc88", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956cca956cc88", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a965cc9a56cc88", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a965cccc9a5688", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44cca965cc9a5688", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956cca965cc88", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956cccca96588", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44cca956cca96588", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956cccca95688", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44cca956cca95688", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2156cca956a95688", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2165cc9a56a96588", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a9659a56cca921", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2156cca956a96588", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956a956cca921", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "44a956a956cca912", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2156a956a956a912", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "21659a56a9659a12", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2156a956a956a921", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a956a93356a912", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a56a93356a921", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "21659a33659a56a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a9659a3321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a956a93356a921", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a956a93321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2156a93356a956a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a956a93312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3356a93356a93312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a33659a33659a", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a33659a333312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a93333659a", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a333356a93312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213333659a33659a", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3356a93356a93321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a93356a9333321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a9333356a93321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a93356a93356a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a93356a933", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a93356a9333312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "213356a9333356a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a9333356a93312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "21333356a93356a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "333356a933333312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3333659a33333321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a333333659a33", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "333356a933333321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3356a933333356a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a933333356a933", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2133333356a93333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3333333333333312", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "333333333333659a", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "33333333659a3333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3333659a33333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "659a333333333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3333333333333321", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "33333333333356a9", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "333333333356a933", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3333333356a93333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "33333356a9333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "333356a933333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "3356a93333333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "56a9333333333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  { code: "2133333333333333", columns: 2, filedUnder: ["parallel"], rows: 8 },
  {
  ...
  { code: "635c699a3", columns: 3, filedUnder: ["snake"], rows: 3 },
  {
  ...
  { code: "6335c65ccca99a33", columns: 4, filedUnder: ["snake"], rows: 4 },
  {
  ...
  { code: "65635c8c4ca39a9", columns: 5, filedUnder: ["swirl"], rows: 3 },
  {
