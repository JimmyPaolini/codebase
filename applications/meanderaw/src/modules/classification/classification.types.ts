...
export interface MeanderClassification {
  ...
  readonly subFamily: SubFamily | undefined;
}
 ...
 *
 * The shape mirrors `SubFamilyRule` deliberately: both are predicates
 ...
 * definition is stated in terms of it — see `ClassificationService`'s
