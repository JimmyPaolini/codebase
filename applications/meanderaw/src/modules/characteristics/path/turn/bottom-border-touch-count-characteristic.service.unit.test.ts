...
describe(BottomBorderTouchCountCharacteristicService, () => {
  let contextService: CharacteristicContextService;
  let service: BottomBorderTouchCountCharacteristicService;
  ...
  beforeAll(async () => {
    ...
    service = await module.resolve(BottomBorderTouchCountCharacteristicService);
  });
  ...
  it.each([
    ...
    { code: "02x02y6588", expected: 2, shape: "a U hanging from the top row" },
    {
      code: "02x02y44a9",
      expected: 1,
    ...
    "counts $expected touches of the bottom border in $shape",
    ({ code, expected }) => {
