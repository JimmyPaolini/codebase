 ...
 * and two legs, legs pointing east — as a 2×3 submatrix scan against the
 ...
 */
@Injectable()
export class AEastLetterCountCharacteristicService implements CharacteristicEvaluator<number> {
  ...
  private readonly template: readonly string[] = ["671", "ab1"];

  // 🔑 Public Fields

  /** Names and explains `aEastLetterCount` for catalogs and inspectors. */
