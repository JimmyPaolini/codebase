 ...
 * end and the middle, prongs pointing west — as a 3×2 submatrix scan against
 ...
 */
@Injectable()
export class FWestLetterCountCharacteristicService implements CharacteristicEvaluator<number> {
  ...
  private readonly template: readonly string[] = [".4", "2d", "29"];

  // 🔑 Public Fields

  /** Names and explains `fWestLetterCount` for catalogs and inspectors. */
