 ...
 * its middle, stem pointing east — as a 3×2 submatrix scan against the glyph's
 * template, drawn:
 *
 * ```text
 * ╷
...
export class TEastLetterCountCharacteristicService implements CharacteristicEvaluator<number> {
  ...
  private readonly template: readonly string[] = ["4.", "e1", "8."];

  // 🔑 Public Fields

  /** Names and explains `tEastLetterCount` for catalogs and inspectors. */
