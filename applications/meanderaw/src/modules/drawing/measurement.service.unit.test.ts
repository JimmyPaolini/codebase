...
import type { DrawingMeasurement } from "./measurement.types";
...
describe(MeasurementService, () => {
  ...
  beforeAll(async () => {
    const module = await Test.createTestingModule({
      providers: [GraphService, LatticeService, MeasurementService],
    }).compile();

    service = await module.resolve(MeasurementService);
  });
