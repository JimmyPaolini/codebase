...
import { MOSAIC_TILE_MINIMUM_ROWS } from "../mosaic-tile/mosaic-tile.constants";

import type { MeanderType } from "./meander-classification.types";
 ...
 * combinations `MeanderClassificationService` tests a structure against.
 */
 ...
 * {@link MOSAIC_TILE_MINIMUM_ROWS} rather than restating it.
 */
...
// so the ten of them live in `MeanderClassificationService.rules` beside the
// helpers they read — the same place `MosaicNamingService` keeps the eight
