...
flowchart LR
  ...
  LexicoIngestionModule --> LoggerModule
  ...
  LibraryModule --> LoggerModule
  LiteratureModule --> DatabaseModule
  LiteratureModule --> LoggerModule
  ...
  PrincipalPartsModule --> LoggerModule
  PrincipalPartsModule --> TypeOrmModule
  PronunciationModule --> LoggerModule
  PronunciationModule --> TypeOrmModule
  TranslationsModule --> LoggerModule
