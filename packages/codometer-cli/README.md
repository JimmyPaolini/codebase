...
| --- | --- | --- | --- |
| `CodometerService.measure` | 15 | `codometer-cli:modules/custom-statistics`, `codometer-cli:modules/discovery`, `codometer-cli:modules/languages` | `packages/codometer-cli/src/modules/codometer/codometer.service.ts:115` |
