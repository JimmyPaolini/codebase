...
`@conformetry/nx` is the thin Nx integration layer for the conformetry toolchain.
...
- It delegates configured generator execution to the conformetry integration facade (`@conformetry/cli`), which owns runtime generation orchestration.
