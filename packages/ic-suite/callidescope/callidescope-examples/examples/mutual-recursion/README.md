...
Then read `cyclicComponentCount` in the `packages/ic-suite/callidescope/callidescope-examples` entry of [`output/report.json`](../../output/report.json)'s `projects`. It is 1 — the cycle of three, counted once.
