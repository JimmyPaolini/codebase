...
```bash
node --import @swc-node/register/esm-register packages/ic-suite/callidescope/callidescope-cli/src/main.ts \
  callidescope --check breadth \
  --config packages/ic-suite/callidescope/callidescope-examples/callidescope.workspace.config.ts \
  --directories packages/ic-suite/callidescope/callidescope-examples,packages/ic-suite/callidescope/callidescope-examples/examples/gated-leaf
```
...
Call stacks traced through `packages/ic-suite/callidescope/callidescope-examples/examples/gated-leaf`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
