...
Then read `unresolvedCallCount` in the `packages/ic-suite/callidescope/callidescope-examples` entry of [`output/report.json`](../../output/report.json)'s `projects`. It is 2: this dropped expansion, and the computed member name.
