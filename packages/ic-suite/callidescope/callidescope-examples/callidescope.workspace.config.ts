...
const callidescopeConfiguration: CallidescopeConfiguration = {
  ...
  write: {
    ...
    json: {
      path: "packages/ic-suite/callidescope/callidescope-examples/output/report.json",
    },
    /** The printed trees, spliced between anchors. */
    markdown: {
      path: "packages/ic-suite/callidescope/callidescope-examples/output/report.md",
    },
    /** The same stacks drawn as one flowchart instead of printed. */
    mermaid: {
      path: "packages/ic-suite/callidescope/callidescope-examples/output/diagram.md",
    },
  },
};
