...
| ------- | --------------- |
| `packages/ic-suite/callidescope/callidescope-examples` | Named — the directory the run was pointed at |
...
`packages/ic-suite/callidescope/callidescope-configuration` excluded. Two rules keep the reached set
...
report for `packages/ic-suite/callidescope/callidescope-examples` in
...
Call stacks traced through `packages/ic-suite/callidescope/callidescope-examples`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
🚀 MutualRecursionService.traverse(remaining: number): number [packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:45]
  ...
  └─> MutualRecursionService.branch(remaining: number): number (cycle) [packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:28]
     ↳ Second of the three, one hop from the leaf.
    └─> MutualRecursionService.leaf(remaining: number): number (cycle) [packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:38]
       ↳ Third of the three, which calls back to the first.
      └─> MutualRecursionService.descend(remaining: number): number (cycle) [packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:33]
...
🚀 bootstrap(): number [packages/ic-suite/callidescope/callidescope-examples/src/main.ts:14]
  ...
  └─> OrdersService.place(available: number): number [packages/ic-suite/callidescope/callidescope-examples/examples/injected-dependency/orders.ts:21]
     ↳ Places one order against the injected inventory.
    └─> InventoryService.reserve(available: number): number [packages/ic-suite/callidescope/callidescope-examples/examples/injected-dependency/inventory.ts:9]
...
🚀 CallbackArgumentService.shoutAll(entries: readonly string[]): string[] [packages/ic-suite/callidescope/callidescope-examples/examples/callback-argument/callback-argument.ts:22]
  ...
  └─> CallbackArgumentService.map(…)(entry: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/callback-argument/callback-argument.ts:23]
    └─> CallbackArgumentService.shout(entry: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/callback-argument/callback-argument.ts:15]
...
🚀 DeclaredEntryPointsService.publish(entries: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/declared-entry-points/declared-entry-points.ts:29]
  ...
  └─> DeclaredEntryPointsService.collect(entries: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/declared-entry-points/declared-entry-points.ts:24]
    ...
    └─> DeclaredEntryPointsService.render(entries: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/declared-entry-points/declared-entry-points.ts:17]
...
🚀 EntryPointsService.onModuleInit(): string [packages/ic-suite/callidescope/callidescope-examples/examples/entry-points/entry-points.ts:29]
  ...
  └─> EntryPointsService.prepareCache(): string [packages/ic-suite/callidescope/callidescope-examples/examples/entry-points/entry-points.ts:22]
...
🚀 EntryPointsService.readReport(): string [packages/ic-suite/callidescope/callidescope-examples/examples/entry-points/entry-points.ts:34]
  ...
  └─> EntryPointsService.buildReport(): string [packages/ic-suite/callidescope/callidescope-examples/examples/entry-points/entry-points.ts:17]
...
🚀 normalizeExampleLabel(label: string): string [packages/ic-suite/callidescope/callidescope-examples/src/index.ts:15]
  ...
  └─> normalizeLabel(label: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/plain-call/normalize-label.ts:2]
...
🚀 BaseClassService.run(): string [packages/ic-suite/callidescope/callidescope-examples/examples/base-class/base-class.ts:16]
  ...
  └─> BaseTaskService.run(): string [packages/ic-suite/callidescope/callidescope-examples/examples/base-class/base-task.ts:9]
...
```text
🚀 PlainCallService.render(label: string): string [packages/ic-suite/callidescope/callidescope-examples/examples/plain-call/plain-call.ts:17]
...
```text
🚀 StructuralInterfaceService.ingestDocument(provider: StructuralProvider, document: string): number [packages/ic-suite/callidescope/callidescope-examples/examples/structural-interface/structural-interface.ts:17]
   ↳ Ingests one document through whatever satisfies the interface.
  └─> FilesystemProviderService.ingest(document: string): number [packages/ic-suite/callidescope/callidescope-examples/examples/structural-interface/structural-provider.ts:25]
...
| --- | --- | --- | --- |
| `bootstrap` | 2 | `OrdersService.place`, `OrdersService.constructor` | `packages/ic-suite/callidescope/callidescope-examples/src/main.ts:14` |
| `BaseClassService.run` | 1 | `BaseTaskService.run` | `packages/ic-suite/callidescope/callidescope-examples/examples/base-class/base-class.ts:16` |
...
| Callable | Breadth | Calls directly | Location |
| --- | --- | --- | --- |
| `CallbackArgumentService.map(…)` | 1 | `CallbackArgumentService.shout` | `packages/ic-suite/callidescope/callidescope-examples/examples/callback-argument/callback-argument.ts:23` |
| `ComputedMemberService.choose` | 1 | `ComputedMemberService.apply` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:28` |
| `ComputedMemberService.normalize` | 1 | `ComputedMemberService.route` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:33` |
| `ComputedMemberService.prepare` | 1 | `ComputedMemberService.choose` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:38` |
| `ComputedMemberService.read` | 1 | `ComputedMemberService.normalize` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:43` |
| `ComputedMemberService.route` | 1 | `ComputedMemberService.select` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:48` |
| `ComputedMemberService.select` | 1 | `ComputedMemberService.prepare` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:53` |
| `ComputedMemberService.dispatch` | 1 | `ComputedMemberService.read` | `packages/ic-suite/callidescope/callidescope-examples/examples/computed-member/computed-member.ts:60` |
| `ConstructedClassService.count` | 1 | `ParserService.constructor` | `packages/ic-suite/callidescope/callidescope-examples/examples/constructed-class/constructed-class.ts:17` |
| `DeclaredEntryPointsService.collect` | 1 | `DeclaredEntryPointsService.render` | `packages/ic-suite/callidescope/callidescope-examples/examples/declared-entry-points/declared-entry-points.ts:24` |
| `DeclaredEntryPointsService.publish` | 1 | `DeclaredEntryPointsService.collect` | `packages/ic-suite/callidescope/callidescope-examples/examples/declared-entry-points/declared-entry-points.ts:29` |
| `DeepStackService.applyTax` | 1 | `DeepStackService.convertCurrency` | `packages/ic-suite/callidescope/callidescope-examples/examples/deep-stack/deep-stack.ts:18` |
| `DeepStackService.convertCurrency` | 1 | `roundToCents` | `packages/ic-suite/callidescope/callidescope-examples/examples/deep-stack/deep-stack.ts:23` |
| `DeepStackService.loadRate` | 1 | `DeepStackService.applyTax` | `packages/ic-suite/callidescope/callidescope-examples/examples/deep-stack/deep-stack.ts:28` |
| `DeepStackService.removeDiscount` | 1 | `DeepStackService.resolveTier` | `packages/ic-suite/callidescope/callidescope-examples/examples/deep-stack/deep-stack.ts:33` |
...
| `ForwardingStackService.execute` | 1 | `ForwardingStackService.forward` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:21` |
| `ForwardingStackService.finish` | 1 | `roundToCents` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:26` |
| `ForwardingStackService.forward` | 1 | `ForwardingStackService.perform` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:31` |
| `ForwardingStackService.perform` | 1 | `ForwardingStackService.relay` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:36` |
| `ForwardingStackService.process` | 1 | `ForwardingStackService.execute` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:41` |
| `ForwardingStackService.relay` | 1 | `ForwardingStackService.finish` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:46` |
| `ForwardingStackService.handle` | 1 | `ForwardingStackService.process` | `packages/ic-suite/callidescope/callidescope-examples/examples/forwarding-stack/forwarding-stack.ts:53` |
| `FrameAnnotationsService.summarize` | 1 | `FrameAnnotationsService.describe` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:27` |
| `FrameAnnotationsService.compose` | 1 | `FrameAnnotationsService.collapseThisSignatureBecauseItRunsLong` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:33` |
| `FrameAnnotationsService.collapseThisSignatureBecauseItRunsLong` | 1 | `FrameAnnotationsService.finish` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:53` |
| `FrameAnnotationsService.describe` | 1 | `FrameAnnotationsService.compose` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:64` |
| `FrameAnnotationsService.legacyRender` | 1 | `FrameAnnotationsService.compose` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:74` |
| `FrameAnnotationsService.render` | 1 | `FrameAnnotationsService.summarize` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:88` |
| `FrameAnnotationsService.trace` | 1 | `FrameAnnotationsService.render` | `packages/ic-suite/callidescope/callidescope-examples/examples/frame-annotations/frame-annotations.ts:95` |
| `OrdersService.place` | 1 | `InventoryService.reserve` | `packages/ic-suite/callidescope/callidescope-examples/examples/injected-dependency/orders.ts:21` |
| `MutualRecursionService.branch` | 1 | `MutualRecursionService.leaf` | `packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:28` |
| `MutualRecursionService.descend` | 1 | `MutualRecursionService.branch` | `packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:33` |
| `MutualRecursionService.leaf` | 1 | `MutualRecursionService.descend` | `packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:38` |
| `MutualRecursionService.traverse` | 1 | `MutualRecursionService.descend` | `packages/ic-suite/callidescope/callidescope-examples/examples/mutual-recursion/mutual-recursion.ts:45` |
| `PlainCallService.render` | 1 | `normalizeLabel` | `packages/ic-suite/callidescope/callidescope-examples/examples/plain-call/plain-call.ts:17` |
| `ProjectDepthLimitService.applyLimit` | 1 | `ProjectDepthLimitService.reportVerdict` | `packages/ic-suite/callidescope/callidescope-examples/examples/project-depth-limit/project-depth-limit.ts:18` |
| `ProjectDepthLimitService.readLimit` | 1 | `ProjectDepthLimitService.applyLimit` | `packages/ic-suite/callidescope/callidescope-examples/examples/project-depth-limit/project-depth-limit.ts:28` |
| `ProjectDepthLimitService.reportVerdict` | 1 | `ProjectDepthLimitService.readDeclaringFile` | `packages/ic-suite/callidescope/callidescope-examples/examples/project-depth-limit/project-depth-limit.ts:33` |
| `ProjectDepthLimitService.resolveConfiguration` | 1 | `ProjectDepthLimitService.readLimit` | `packages/ic-suite/callidescope/callidescope-examples/examples/project-depth-limit/project-depth-limit.ts:38` |
| `ProjectDepthLimitService.judge` | 1 | `ProjectDepthLimitService.resolveConfiguration` | `packages/ic-suite/callidescope/callidescope-examples/examples/project-depth-limit/project-depth-limit.ts:45` |
| `StructuralInterfaceService.ingestDocument` | 1 | `FilesystemProviderService.ingest` | `packages/ic-suite/callidescope/callidescope-examples/examples/structural-interface/structural-interface.ts:17` |
