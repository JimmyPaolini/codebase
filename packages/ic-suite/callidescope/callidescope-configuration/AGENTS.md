# CallidescopeConfiguration: NestJS Service Application
...
```bash
nx run callidescope-configuration:type-codebase,lint-codebase,form-codebase,scrub-codebase,gate-codebase   # Every static check, in one graph
