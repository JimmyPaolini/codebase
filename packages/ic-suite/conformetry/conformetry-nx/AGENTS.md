# ConformetryNx: NestJS Service Application
...
```bash
nx run conformetry-nx:type-codebase,lint-codebase,form-codebase,scrub-codebase,gate-codebase   # Every static check, in one graph
