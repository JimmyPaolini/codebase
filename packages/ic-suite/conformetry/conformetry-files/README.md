...
Call stacks traced through `packages/ic-suite/conformetry/conformetry-files`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
| --- | --- | --- | --- |
| `FilesService.checkInstanceFiles` | 3 | `InstanceDiscoveryService.resolveInstanceFiles`, `FilesService.buildMissingDifference`, `FilesService.countExpectedFiles` | `packages/ic-suite/conformetry/conformetry-files/src/modules/files/files.service.ts:95` |
| `FilesService.buildMissingDifference` | 2 | `DifferencesService.buildMissingFileDifference`, `DifferencesService.buildMissingDirectoryDifference` | `packages/ic-suite/conformetry/conformetry-files/src/modules/files/files.service.ts:51` |
| `FilesService.countExpectedFiles` | 1 | `FilesService.filter(…)` | `packages/ic-suite/conformetry/conformetry-files/src/modules/files/files.service.ts:77` |
<!-- CALL_STACKS_END -->
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-588-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-29.01_kB-6b7280?style=flat-square)
...
![Functions](https://img.shields.io/badge/Functions-23-16a34a?style=flat-square)
...
![Imports](https://img.shields.io/badge/Imports-35-0284c7?style=flat-square)
![Exported Symbols](https://img.shields.io/badge/Exported_Symbols-7-ea580c?style=flat-square)
![Comments](https://img.shields.io/badge/Comments-38-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-105-475569?style=flat-square)
