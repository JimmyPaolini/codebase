# ConformetryConfiguration: NestJS Service Application
...
```bash
nx run conformetry-configuration:type-codebase,lint-codebase,form-codebase,scrub-codebase,gate-codebase   # Every static check, in one graph
