...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-1123-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-106.67_kB-6b7280?style=flat-square)
...
![TypeScript Files](https://img.shields.io/badge/TypeScript_Files-50-3178c6?style=flat-square)
...
![Doc Comments](https://img.shields.io/badge/Doc_Comments-68-6366f1?style=flat-square)
...
![JSON Lines](https://img.shields.io/badge/JSON_Lines-277-ca8a04?style=flat-square)
...
![JSON Nodes](https://img.shields.io/badge/JSON_Nodes-226-dc2626?style=flat-square)
...
![Markdown Lines](https://img.shields.io/badge/Markdown_Lines-1546-1f6feb?style=flat-square)
...
Call stacks traced through `packages/ic-suite/conformetry/conformetry-examples`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
```text
🚀 main(): Promise<void> [packages/ic-suite/conformetry/conformetry-examples/examples/embedding/embed.ts:44]
...
| --- | --- | --- | --- |
| `main` | 13 | `packages/ic-suite/conformetry/conformetry-configuration:modules/configuration`, `packages/ic-suite/conformetry/conformetry-configuration:modules/template-discovery`, `packages/ic-suite/conformetry/conformetry-core:modules/reporting`, `packages/ic-suite/conformetry/conformetry-generation:modules/generation`, `packages/ic-suite/conformetry/conformetry-validation:modules/validation` | `packages/ic-suite/conformetry/conformetry-examples/examples/embedding/embed.ts:44` |

### Breadth

| Callable | Breadth | Calls directly | Location |
| --- | --- | --- | --- |
| `main` | 6 | `ConfigurationService.loadConformetryConfiguration`, `GenerationService.runGenerator`, `ValidationService.validate`, `flatMap(…)`, `TemplateDiscoveryService.collectTemplates`, `ReportingService.formatReport` | `packages/ic-suite/conformetry/conformetry-examples/examples/embedding/embed.ts:44` |
| `flatMap(…)` | 1 | `InstanceDiscoveryService.findInstances` | `packages/ic-suite/conformetry/conformetry-examples/examples/embedding/embed.ts:81` |
