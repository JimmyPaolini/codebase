...
```bash
pnpm exec nx run conformetry-cli:start -- validate --config packages/ic-suite/conformetry/conformetry-examples/examples/language-validators/conformetry.config.ts --languages typescript
```
