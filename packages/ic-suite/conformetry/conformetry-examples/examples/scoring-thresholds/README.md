...
```bash
pnpm exec nx run conformetry-cli:start -- validate --config packages/ic-suite/conformetry/conformetry-examples/examples/scoring-thresholds/conformetry.config.ts --threshold 0.5
```
