...
```bash
pnpm exec nx run conformetry-cli:start -- instances --config packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/conformetry.config.ts
```

```text
  packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/instances/alpha
    Templates:
      card 2/2 files 100%
      panel 1/2 files 50%
  packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/instances/beta
    Templates:
      panel 2/2 files 100%
      card 1/2 files 50%
```
...
```bash
pnpm exec nx run conformetry-cli:start -- templates --config packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/conformetry.config.ts --instances packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/instances/alpha
```

```text
  card
    A card: the document and its back
    Template: packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/templates/card
    Instances:
      packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/instances/alpha 2/2 files 100%
  panel
    A panel: the document and its manifest
    Template: packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/templates/panel
    Instances:
      packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/instances/alpha 1/2 files 50%
```
...
```bash
pnpm exec nx run conformetry-cli:start -- templates --config packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/conformetry.config.ts
```
...
```bash
pnpm exec nx run conformetry-cli:start -- instances --config packages/ic-suite/conformetry/conformetry-examples/examples/two-directions/conformetry.config.ts --templates card
```
