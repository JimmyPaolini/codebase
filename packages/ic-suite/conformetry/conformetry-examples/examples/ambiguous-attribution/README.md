...
```bash
pnpm exec nx run conformetry-cli:start -- templates --config packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/conformetry.config.ts --instances packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/guide
```

```text
  overview
    A two-file template: the document, and its notes
    Template: packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/templates/overview
    Instances:
      packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/guide 2/2 files 100%
  digest
    A two-file template: the document, and its summary
    Template: packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/templates/digest
    Instances:
      packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/guide 1/2 files 50%
```
...
```bash
pnpm exec nx run conformetry-cli:start -- templates --config packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/conformetry.config.ts --instances packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/atlas
```

```text
  overview
    …
      packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/atlas 1/2 files 50%
  digest
    …
      packages/ic-suite/conformetry/conformetry-examples/examples/ambiguous-attribution/instances/atlas 1/2 files 50%
```
