...
```bash
pnpm exec nx run conformetry-cli:start -- generate --template hello --name mars --directory tmp/conformetry-examples/hello-template --config packages/ic-suite/conformetry/conformetry-examples/examples/hello-template/conformetry.config.ts
```
...
```bash
pnpm exec nx run conformetry-cli:start -- validate --config packages/ic-suite/conformetry/conformetry-examples/examples/hello-template/conformetry.config.ts --instances 'tmp/conformetry-examples/hello-template/*'
```
