...
Call stacks traced through `packages/ic-suite/codometer/codometer-customization`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
| --- | --- | --- | --- |
| `CustomizationService.buildCommentResult` | 2 | `CustomizationService.filter(…)`, `CustomizationService.map(…)` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:43` |
| `CustomizationService.map(…)` | 2 | `CustomizationService.buildCommentResult`, `CustomizationService.countMatches` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:86` |
| `CustomizationService.countMatches` | 1 | `CustomizationService.filter(…)` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:71` |
...
| Callable | Breadth | Calls directly | Location |
| --- | --- | --- | --- |
| `CustomizationService.filter(…)` | 1 | `CustomizationService.some(…)` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:72` |
| `CustomizationService.analyze` | 1 | `CustomizationService.map(…)` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:80` |
| `CustomizationService.buildSymbolCounters` | 1 | `CustomizationService.flatMap(…)` | `packages/ic-suite/codometer/codometer-customization/src/modules/customization/customization.service.ts:148` |
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-718-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-31.44_kB-6b7280?style=flat-square)
...
![Compiled JavaScript Size](https://img.shields.io/badge/Compiled_JavaScript_Size-2.31_kB_gzip-6b7280?style=flat-square)
...
![Doc Comments](https://img.shields.io/badge/Doc_Comments-15-6366f1?style=flat-square)
...
![Functions](https://img.shields.io/badge/Functions-28-16a34a?style=flat-square)
![Methods](https://img.shields.io/badge/Methods-11-15803d?style=flat-square)
![Sync Functions](https://img.shields.io/badge/Sync_Functions-38-4ade80?style=flat-square)
...
![Imports](https://img.shields.io/badge/Imports-26-0284c7?style=flat-square)
![Exported Symbols](https://img.shields.io/badge/Exported_Symbols-5-ea580c?style=flat-square)
![Comments](https://img.shields.io/badge/Comments-34-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-101-475569?style=flat-square)
