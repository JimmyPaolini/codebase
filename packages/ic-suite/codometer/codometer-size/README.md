...
Call stacks traced through `packages/ic-suite/codometer/codometer-size`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
| --- | --- | --- | --- |
| `SizeService.measureFile` | 2 | `SizeService.compress`, `UnreadableTargetFileError.constructor` | `packages/ic-suite/codometer/codometer-size/src/modules/size/size.service.ts:61` |
| `SizeService.analyze` | 1 | `SizeService.measureFile` | `packages/ic-suite/codometer/codometer-size/src/modules/size/size.service.ts:85` |
<!-- CALL_STACKS_END -->
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-754-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-33.79_kB-6b7280?style=flat-square)
...
![Compiled JavaScript Size](https://img.shields.io/badge/Compiled_JavaScript_Size-2.65_kB_gzip-6b7280?style=flat-square)
...
![Comments](https://img.shields.io/badge/Comments-45-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-133-475569?style=flat-square)
