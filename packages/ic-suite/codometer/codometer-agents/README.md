...
```bash
npx skills add JimmyPaolini/codebase/packages/ic-suite/codometer/codometer-agents/skills --skill '*'
```
...
![Repository Size](https://img.shields.io/badge/Repository_Size-41.37_kB-6b7280?style=flat-square)
...
![Markdown Lines](https://img.shields.io/badge/Markdown_Lines-692-1f6feb?style=flat-square)
...
![Paragraphs](https://img.shields.io/badge/Paragraphs-84-64748b?style=flat-square)
...
![Table Rows](https://img.shields.io/badge/Table_Rows-36-0ea5e9?style=flat-square)
...
![Inline Code](https://img.shields.io/badge/Inline_Code-272-ef4444?style=flat-square)
