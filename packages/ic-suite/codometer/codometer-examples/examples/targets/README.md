...
```bash
cp -R packages/ic-suite/codometer/codometer-examples/examples/compiled packages/ic-suite/codometer/codometer-examples/examples/corpus/generated
cd packages/ic-suite/codometer/codometer-examples/examples/corpus
codometer --config ../targets/ignored.config.ts
rm -rf packages/ic-suite/codometer/codometer-examples/examples/corpus/generated
```
