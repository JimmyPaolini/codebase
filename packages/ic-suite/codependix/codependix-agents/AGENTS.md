...
[`conformetry-agents`](../../conformetry/conformetry-agents/testing/skills.unit.test.ts) and
[`codometer-agents`](../../codometer/codometer-agents/testing/skills.unit.test.ts). That is
