...
/** Graph type `codependix-file-imports` builds. */
...
/** Graph type this ticket's `codependix-nx-projects` package builds. */
...
/** Graph type `codependix-file-imports`'s Python module builds. */
