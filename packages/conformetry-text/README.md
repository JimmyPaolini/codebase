...
![Repository Size](https://img.shields.io/badge/Repository_Size-21.89_kB-6b7280?style=flat-square)
![Folders](https://img.shields.io/badge/Folders-4-4a4a4a?style=flat-square)
![Source Files](https://img.shields.io/badge/Source_Files-11-3178c6?style=flat-square)

### Measured Targets

![Compiled JavaScript Size](https://img.shields.io/badge/Compiled_JavaScript_Size-1.94_kB_gzip-6b7280?style=flat-square)

### TypeScript

![TypeScript Files](https://img.shields.io/badge/TypeScript_Files-11-3178c6?style=flat-square)
...
![Doc Comments](https://img.shields.io/badge/Doc_Comments-11-6366f1?style=flat-square)
...
![Functions](https://img.shields.io/badge/Functions-24-16a34a?style=flat-square)
![Methods](https://img.shields.io/badge/Methods-4-15803d?style=flat-square)
![Sync Functions](https://img.shields.io/badge/Sync_Functions-27-4ade80?style=flat-square)
![Async Functions](https://img.shields.io/badge/Async_Functions-1-059669?style=flat-square)
![Constants](https://img.shields.io/badge/Constants-17-dc2626?style=flat-square)
![Imports](https://img.shields.io/badge/Imports-22-0284c7?style=flat-square)
![Exported Symbols](https://img.shields.io/badge/Exported_Symbols-7-ea580c?style=flat-square)
![Comments](https://img.shields.io/badge/Comments-27-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-51-475569?style=flat-square)
...
graph LR
  ...
  file_src_modules_text_validator_text_validator_constants_ts["src/modules/text-validator/text-validator.constants.ts"]
  file_src_modules_text_validator_text_validator_module_ts["src/modules/text-validator/text-validator.module.ts"]
  file_src_modules_text_validator_text_validator_module_unit_test_ts["src/modules/text-validator/text-validator.module.unit.test.ts"]
  file_src_modules_text_validator_text_validator_service_ts["src/modules/text-validator/text-validator.service.ts"]
  file_src_modules_text_validator_text_validator_service_unit_test_ts["src/modules/text-validator/text-validator.service.unit.test.ts"]
  file_src_modules_text_validator_text_validator_types_ts["src/modules/text-validator/text-validator.types.ts"]
  file_testing_mocks_ts["testing/mocks.ts"]
  file_testing_setup_ts["testing/setup.ts"]
  file_vitest_config_ts["vitest.config.ts"]
  file_src_modules_text_validator_text_validator_module_ts --> file_src_modules_text_validator_text_validator_service_ts
  file_src_modules_text_validator_text_validator_module_unit_test_ts --> file_src_modules_text_validator_text_validator_module_ts
  file_src_modules_text_validator_text_validator_module_unit_test_ts --> file_src_modules_text_validator_text_validator_service_ts
  file_src_modules_text_validator_text_validator_service_ts --> file_src_modules_text_validator_text_validator_constants_ts
  file_src_modules_text_validator_text_validator_service_ts --> file_src_modules_text_validator_text_validator_types_ts
  file_src_modules_text_validator_text_validator_service_unit_test_ts --> file_src_modules_text_validator_text_validator_service_ts
```
