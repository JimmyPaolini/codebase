...
/**
 * What conformetry-jupyter is held to: the workspace's own depth, and a
 * breadth measured here.
 *
 * A leaf analyzer. Its twenty-two callables are real code, but every one of them
 ...
 * real widest to gate. Eleven direct callees at the widest — ordinary fan-out
