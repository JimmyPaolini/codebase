...
```bash
pnpm exec nx run conformetry-cli:start -- generate --generator hello --name mars --no-interactive --directory tmp/conformetry-examples/hello-template --config packages/conformetry-examples/examples/hello-template/conformetry.config.ts
```
