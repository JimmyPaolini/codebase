...
Call stacks traced through `codometer-markdown`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
```text
🚀 RenderService.renderRow(row: MetricRow): string [packages/codometer-markdown/src/modules/render/render.service.ts:134]
   ↳ Renders one table row.
  └─> formatDelta(delta: number | undefined, unit: MetricUnit): string [packages/codometer-markdown/src/modules/render/render.utilities.ts:23]
     ↳ Formats a signed delta, or an em dash when there is nothing to compare.
    └─> formatValue(value: number, unit: MetricUnit): string [packages/codometer-markdown/src/modules/render/render.utilities.ts:33]
...
**2. `RenderService.renderProject`** — depth 3 · orphan-root

```text
🚀 RenderService.renderProject(…): string[] [packages/codometer-markdown/src/modules/render/render.service.ts:106]
   ↳ Renders one project's block, or nothing if it has nothing to show.
  └─> RenderService.readIsOpen(rows: readonly MetricRow[], failures: readonly ProjectFailure[]): boolean [packages/codometer-markdown/src/modules/render/render.service.ts:47]
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-1285-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-49.98_kB-6b7280?style=flat-square)
...
![Compiled JavaScript Size](https://img.shields.io/badge/Compiled_JavaScript_Size-6.07_kB_gzip-6b7280?style=flat-square)
...
![Doc Comments](https://img.shields.io/badge/Doc_Comments-30-6366f1?style=flat-square)
...
![Methods](https://img.shields.io/badge/Methods-23-15803d?style=flat-square)
![Sync Functions](https://img.shields.io/badge/Sync_Functions-96-4ade80?style=flat-square)
![Async Functions](https://img.shields.io/badge/Async_Functions-10-059669?style=flat-square)
![Constants](https://img.shields.io/badge/Constants-80-dc2626?style=flat-square)
...
![Comments](https://img.shields.io/badge/Comments-51-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-98-475569?style=flat-square)
