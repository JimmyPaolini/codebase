...
flowchart LR
  ...
  DiscoveryModule
  ExplainModule --> ConfigurationModule
  ExplainModule --> InputModule
  ExplainModule --> TemplateDiscoveryModule
  ...
  ListModule --> ConfigurationModule
  ListModule --> InputModule
  MainModule --> DiscoveryModule
  MainModule --> ExplainModule
  MainModule --> GenerateModule
  MainModule --> ListModule
