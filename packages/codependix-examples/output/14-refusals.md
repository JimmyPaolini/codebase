# 14. Every refusal, with its reproduction
...
```text
ConfigurationFileNotFoundError: Configuration file not found: <fixtures>/configuration/absent/codependix.config.missing.ts
```
...
```text
UnknownConfigurationFileTypeError: Unsupported configuration file type: <fixtures>/configuration/unsupported-type/codependix.config.yaml
```
