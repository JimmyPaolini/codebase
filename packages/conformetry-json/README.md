...
Call stacks traced through `packages/conformetry-json`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
graph LR
  ...
  file_src_modules_json_validator_json_comparison_service_ts["src/modules/json-validator/json-comparison.service.ts"]
  file_src_modules_json_validator_json_comparison_service_unit_test_ts["src/modules/json-validator/json-comparison.service.unit.test.ts"]
  file_src_modules_json_validator_json_validator_constants_ts["src/modules/json-validator/json-validator.constants.ts"]
  file_src_modules_json_validator_json_validator_module_ts["src/modules/json-validator/json-validator.module.ts"]
  file_src_modules_json_validator_json_validator_module_unit_test_ts["src/modules/json-validator/json-validator.module.unit.test.ts"]
  file_src_modules_json_validator_json_validator_service_ts["src/modules/json-validator/json-validator.service.ts"]
  file_src_modules_json_validator_json_validator_service_unit_test_ts["src/modules/json-validator/json-validator.service.unit.test.ts"]
  file_src_modules_json_validator_json_validator_types_ts["src/modules/json-validator/json-validator.types.ts"]
  file_testing_mocks_ts["testing/mocks.ts"]
  file_testing_setup_ts["testing/setup.ts"]
  file_vitest_config_ts["vitest.config.ts"]
  file_src_modules_json_validator_json_comparison_service_ts --> file_src_modules_json_validator_json_validator_types_ts
  file_src_modules_json_validator_json_comparison_service_unit_test_ts --> file_src_modules_json_validator_json_comparison_service_ts
  file_src_modules_json_validator_json_comparison_service_unit_test_ts --> file_src_modules_json_validator_json_validator_types_ts
  file_src_modules_json_validator_json_validator_module_ts --> file_src_modules_json_validator_json_comparison_service_ts
  file_src_modules_json_validator_json_validator_module_ts --> file_src_modules_json_validator_json_validator_service_ts
  file_src_modules_json_validator_json_validator_module_unit_test_ts --> file_src_modules_json_validator_json_validator_module_ts
  file_src_modules_json_validator_json_validator_module_unit_test_ts --> file_src_modules_json_validator_json_validator_service_ts
  file_src_modules_json_validator_json_validator_service_ts --> file_src_modules_json_validator_json_comparison_service_ts
  file_src_modules_json_validator_json_validator_service_ts --> file_src_modules_json_validator_json_validator_constants_ts
  file_src_modules_json_validator_json_validator_service_ts --> file_src_modules_json_validator_json_validator_types_ts
  file_src_modules_json_validator_json_validator_service_unit_test_ts --> file_src_modules_json_validator_json_comparison_service_ts
  file_src_modules_json_validator_json_validator_service_unit_test_ts --> file_src_modules_json_validator_json_validator_service_ts
```
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-864-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-37.33_kB-6b7280?style=flat-square)
...
![Compiled JavaScript Size](https://img.shields.io/badge/Compiled_JavaScript_Size-4.33_kB_gzip-6b7280?style=flat-square)
...
![Doc Comments](https://img.shields.io/badge/Doc_Comments-17-6366f1?style=flat-square)
...
![Classes](https://img.shields.io/badge/Classes-3-7c3aed?style=flat-square)
![Functions](https://img.shields.io/badge/Functions-39-16a34a?style=flat-square)
![Methods](https://img.shields.io/badge/Methods-21-15803d?style=flat-square)
![Sync Functions](https://img.shields.io/badge/Sync_Functions-58-4ade80?style=flat-square)
![Async Functions](https://img.shields.io/badge/Async_Functions-2-059669?style=flat-square)
![Constants](https://img.shields.io/badge/Constants-35-dc2626?style=flat-square)
...
![Comments](https://img.shields.io/badge/Comments-43-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-81-475569?style=flat-square)
...
![JSON Lines](https://img.shields.io/badge/JSON_Lines-145-ca8a04?style=flat-square)
...
![JSON Nodes](https://img.shields.io/badge/JSON_Nodes-130-dc2626?style=flat-square)
