...
Call stacks traced through `packages/conformetry-markdown`, deepest first. Each frame shows what it takes, what it returns, and what its documentation says.
...
graph LR
  ...
  file_src_modules_markdown_validator_markdown_nodes_service_ts["src/modules/markdown-validator/markdown-nodes.service.ts"]
  file_src_modules_markdown_validator_markdown_nodes_service_unit_test_ts["src/modules/markdown-validator/markdown-nodes.service.unit.test.ts"]
  file_src_modules_markdown_validator_markdown_tree_service_ts["src/modules/markdown-validator/markdown-tree.service.ts"]
  file_src_modules_markdown_validator_markdown_tree_service_unit_test_ts["src/modules/markdown-validator/markdown-tree.service.unit.test.ts"]
  file_src_modules_markdown_validator_markdown_validator_constants_ts["src/modules/markdown-validator/markdown-validator.constants.ts"]
  file_src_modules_markdown_validator_markdown_validator_module_ts["src/modules/markdown-validator/markdown-validator.module.ts"]
  file_src_modules_markdown_validator_markdown_validator_module_unit_test_ts["src/modules/markdown-validator/markdown-validator.module.unit.test.ts"]
  file_src_modules_markdown_validator_markdown_validator_service_ts["src/modules/markdown-validator/markdown-validator.service.ts"]
  file_src_modules_markdown_validator_markdown_validator_service_unit_test_ts["src/modules/markdown-validator/markdown-validator.service.unit.test.ts"]
  file_src_modules_markdown_validator_markdown_validator_types_ts["src/modules/markdown-validator/markdown-validator.types.ts"]
  file_testing_mocks_ts["testing/mocks.ts"]
  file_testing_setup_ts["testing/setup.ts"]
  file_vitest_config_ts["vitest.config.ts"]
  file_src_modules_markdown_validator_markdown_nodes_service_ts --> file_src_modules_markdown_validator_markdown_validator_constants_ts
  file_src_modules_markdown_validator_markdown_nodes_service_ts --> file_src_modules_markdown_validator_markdown_validator_types_ts
  file_src_modules_markdown_validator_markdown_nodes_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_nodes_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_validator_types_ts
  file_src_modules_markdown_validator_markdown_tree_service_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_tree_service_ts --> file_src_modules_markdown_validator_markdown_validator_constants_ts
  file_src_modules_markdown_validator_markdown_tree_service_ts --> file_src_modules_markdown_validator_markdown_validator_types_ts
  file_src_modules_markdown_validator_markdown_tree_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_tree_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_tree_service_ts
  file_src_modules_markdown_validator_markdown_tree_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_validator_types_ts
  file_src_modules_markdown_validator_markdown_validator_module_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_validator_module_ts --> file_src_modules_markdown_validator_markdown_tree_service_ts
  file_src_modules_markdown_validator_markdown_validator_module_ts --> file_src_modules_markdown_validator_markdown_validator_service_ts
  file_src_modules_markdown_validator_markdown_validator_module_unit_test_ts --> file_src_modules_markdown_validator_markdown_validator_module_ts
  file_src_modules_markdown_validator_markdown_validator_module_unit_test_ts --> file_src_modules_markdown_validator_markdown_validator_service_ts
  file_src_modules_markdown_validator_markdown_validator_service_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_validator_service_ts --> file_src_modules_markdown_validator_markdown_tree_service_ts
  file_src_modules_markdown_validator_markdown_validator_service_ts --> file_src_modules_markdown_validator_markdown_validator_constants_ts
  file_src_modules_markdown_validator_markdown_validator_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_nodes_service_ts
  file_src_modules_markdown_validator_markdown_validator_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_tree_service_ts
  file_src_modules_markdown_validator_markdown_validator_service_unit_test_ts --> file_src_modules_markdown_validator_markdown_validator_service_ts
```
...
![Lines of Code](https://img.shields.io/badge/Lines_of_Code-1183-22c55e?style=flat-square)
![Repository Size](https://img.shields.io/badge/Repository_Size-47.74_kB-6b7280?style=flat-square)
...
![Comments](https://img.shields.io/badge/Comments-74-64748b?style=flat-square)
![Comment Lines](https://img.shields.io/badge/Comment_Lines-169-475569?style=flat-square)
