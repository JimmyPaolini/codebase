...
describe(WriteReadmeService, () => {
  ...
  const sampleStatistics = {
    ...
    jsFiles: 13,
    linesOfCode: 14,
    markdownBlockquotes: 29,
    markdownCodeBlocks: 30,
    markdownElements: 31,
    markdownFiles: 32,
    markdownHeaders: 33,
    markdownImages: 34,
    markdownInlineCode: 35,
    markdownLines: 36,
    markdownLinks: 37,
    markdownListItems: 38,
    markdownLists: 39,
    markdownOtherElements: 40,
    markdownParagraphs: 41,
    markdownTables: 42,
    markdownThematicBreaks: 43,
    methods: 15,
    pythonClasses: 16,
    pythonConstants: 17,
    pythonDecorators: 18,
