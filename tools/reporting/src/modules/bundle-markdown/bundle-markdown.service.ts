...
export class BundleMarkdownService {
  ...
  private renderGuidelines(): string[] {
    return [
      ...
      "declared per project rather than assumed here. Packages declare a limit",
      "in `configuration/codometer.config.ts`, or in a `codometer.config.cjs`",
      "of their own; add a `codometer` target to include a project here.",
      "",
