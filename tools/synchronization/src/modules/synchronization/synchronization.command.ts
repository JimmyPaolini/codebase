 ...
 * aggregate because they no longer exist at all: `packages/ic-suite/codependix/codependix-nx-projects` and
 * `packages/ic-suite/codependix/codependix-nestjs-modules` now produce the same graphs through their own
