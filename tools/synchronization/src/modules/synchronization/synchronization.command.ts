 ...
 * aggregate because they no longer exist at all: `packages/ic-suite/codependix/codependix-nx` and
 * `packages/ic-suite/codependix/codependix-nestjs` now produce the same graphs through their own
