...
import type { CodometerTargetsModule } from "./modules/codometer-targets/codometer-targets.module";
...
const codometerTargetsModuleMock = createMock<CodometerTargetsModule>();
...
vi.mock("./modules/codometer-targets/codometer-targets.module", () => ({
  CodometerTargetsModule: function CodometerTargetsModule() {
    return codometerTargetsModuleMock;
  },
}));
